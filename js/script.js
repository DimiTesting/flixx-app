const global = {
    ...
    api: {
        API_KEY: "9a81bb366312fe2f0a1edac4c7906ae4",
...
function addComasToNumbers(number) {
...
async function displayMovieDetails() {
    ...
    div.innerHTML = `
        ...
        <div class="details-bottom">
            <h2>Movie Info</h2>
            <ul>
                <li><span class="text-secondary">Budget:</span> $${addComasToNumbers(movie.budget)}</li>
                <li><span class="text-secondary">Revenue:</span> $${addComasToNumbers(movie.revenue)}</li>
...
async function displayShowDetails() {
    ...
    displayBackground("show", show.backdrop_path)
...
function showSearchResults(results) {
    ...
    if (results.length===0) {
        customAlert("Movie not Found", "success")
    } else {
...
async function search() {
    ...
    if (global.search.term !== "" && global.search.term !== null) {
        ...
        customAlert("Please enter something")
    }
}
